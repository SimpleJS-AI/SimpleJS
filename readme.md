...
<h3 align="center">SimpleJS</h3>
  ...
  <p align="center">
    description
    <br />
    <a href="https://github.com/flug8/SimpleJS"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/flug8/SimpleJS">View Demo</a>
    ·
...
2. Clone the repo
   ```sh
   git clone https://github.com/flug8/SimpleJS.git
   ```
...
See the [open issues](https://github.com/flug8/SimpleJS/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/flug8/SimpleJS](https://github.com/flug8/SimpleJS)
